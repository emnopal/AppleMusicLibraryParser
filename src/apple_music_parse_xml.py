...
class AppleMusicParseXML:
    ...
    def save_to_json(self, path_to_save: Optional[str] = None, cols_to_select: Optional[List[str]] = None, **kwargs) -> None:
    ...
    def save_to_yaml(self, path_to_save: Optional[str] = None, cols_to_select: Optional[List[str]] = None, **kwargs) -> None:
    ...
    def _to_dataframe(self, cols_to_select: Optional[List[str]] = None, **kwargs) -> pd.DataFrame:
    ...
    def save_to_csv(self, path_to_save: Optional[str] = None, cols_to_select: Optional[List[str]] = None, show_index: bool = False, **kwargs) -> None:
